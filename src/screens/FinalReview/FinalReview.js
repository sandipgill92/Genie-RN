        ...
        >
          ...
          <View style={styles.offerList}>
            <TouchableOpacity style={styles.offerRow} activeOpacity={0.7}>
              <View style={[styles.offerRow, { paddingVertical: 0 }]}>
                <View style={styles.offerIcon}>
                  <VerifyGreenIcon />
                </View>
                <View>
                  <Text style={styles.offerLabel}>
                    You just saved J$1,270 {'\n'}with SUMMER20!
                  </Text>
                  <Text style={styles.offerLabel}>view all offers </Text>
                </View>
              </View>
              <TouchableOpacity>
                <Text style={styles.removeBtn}>Remove</Text>
            ...
            <TouchableOpacity style={styles.offerRow} activeOpacity={0.7}>
              <View style={[styles.offerRow, { paddingVertical: 0 }]}>
                ...
                <View>
                  <Text style={styles.offerLabel}>View all payment deals</Text>
                </View>{' '}
              </View>
              <RightIcon />
            </TouchableOpacity>
          ...
          <View style={{ marginTop: 20 }}>
            ...
            <View style={styles.card}>
              ...
              <View style={[styles.payRow, { marginTop: 10 }]}>
                <Text style={[styles.payLabel, { color: appColors.primary }]}>
                  Discount
                </Text>
                <Text
                  style={[
